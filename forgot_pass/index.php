...
<h2 align="center">Forgot Password ? Reset Here</h2> 
...
<form name="frmForgot" id="frmForgot" method="post" onSubmit="return validate_forgot();">
    ...
    <div class="image-group">
		<div align="center"><img src="../images/forgotpass.png" width="130px" height="100px"/></div>
	</div>
    
	<div class="field-group">
        <div><label for="username"><h4>Username</h4></label></div>
		<div><input type="text" name="user-login-name" id="user-login-name" class="input-field">
        <br><br><h2> Or </h2></div>
	</div>
	
	<div class="field-group">
        <div><label for="email"><h4>Email</h4></label></div>
...
<?php
	if(!empty($_POST["forgot-password"])){
		...
		if(!empty($_POST["user-login-name"])) 
			$condition = " customer_name = '" . $_POST["user-login-name"] . "'";
